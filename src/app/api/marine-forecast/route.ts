...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({ forecast: forecast ?? null, source, health, advisory: 'Model guidance only. Sea level/current accuracy is limited near coasts and must not be used for navigation.' }, {
