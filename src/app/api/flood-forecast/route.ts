...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    source,
    health,
    advisory: 'GloFAS model guidance, not an official local flood warning or gauge measurement. WSV Pegelonline remains primary for German federal-waterway gauges.',
