...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? "https://liveworld-map.vercel.app";
const SITE_NAME = "LiveWorld Map";
const SITE_TITLE = "LiveWorld Map — Global Real-Time Intelligence & Civil Protection Platform";
const SITE_DESCRIPTION = "LiveWorld Map — Advanced global situational awareness dashboard for live flights, European rail departures, civil-protection alerts, waterways, power-grid flows, maritime routes, CCTV, earthquakes, and OSINT tools. Developed by fcflo151; built on the original OSIRIS foundation by simplifaisoul.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Brand
    "LiveWorld Map", "liveworld map", "global intelligence map", "civil protection map",
  ],
  authors: [{ name: "fcflo151", url: "https://github.com/fcflo151" }, { name: "simplifaisoul (Original OSIRIS Creator)", url: "https://github.com/simplifaisoul/osiris" }],
  creator: "fcflo151 & simplifaisoul",
  publisher: "LiveWorld Map",
  robots: {
    index: true,
    follow: true,
    googleBot: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "LiveWorld Map — Global real-time intelligence and civil protection platform",
        type: "image/png",
      },
    ],
  },
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: SITE_NAME,
  alternateName: ["LiveWorld Map", "LiveWorld Intelligence Map"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="LiveWorld Map">
          {children}
        </ErrorBoundary>
      </body>
    </html>
